...
<body style='background:url(__ROOT__/Public/img/1024x768girl.jpg) repeat-x;'>
<form class="form-horizontal"  name="myForm" action="__ROOT__/login/login/" method="post">
    <div style="width:500px;height:250px;margin:5% auto;border:2px #f6f8f9 solid;">
        <fieldset>
            <legend style="margin-bottom:12px;"><span style="margin-left:160px;"><?php echo APP_NAME;?></span></legend>
            ...
            <div class="control-group wml">
                ...
                <input id="username" name="username" type="text" onblur="checkUsername();" placeholder="用户名" value="<?php echo ($username); ?>" maxlength=32>
            ...
            <div class="control-group wml">
                <div class="controls input-prepend" style='display:block;'>
                    ...
                    <img src="__ROOT__/login/checkcode/" style="cursor:pointer;" onclick="this.src='__ROOT__/index/checkcode/id/'+Math.random()*5;"/>
            ...
            <div class="control-group wml">
              <div class="controls">
                ...
                <a style="margin-left:20px;" href="__ROOT__/reg/" class="btn">注册</a>
              </div>
            </div>
        </fieldset>
    </div>
...
function checkCode(){
    ...
    var url = "__ROOT__/login/ajaxcheckrandcode/checkcode/"+checkcode;
